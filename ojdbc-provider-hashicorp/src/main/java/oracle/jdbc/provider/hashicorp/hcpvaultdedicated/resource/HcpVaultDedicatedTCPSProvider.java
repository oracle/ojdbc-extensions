 ...
 * with an Autonomous Database. The file is retrieved from HashiCorp Vault Dedicated,
 ...
 * </p>
 */
public class HcpVaultDedicatedTCPSProvider
   ...
   */
  public HcpVaultDedicatedTCPSProvider() {
    super("tls", TCPS_PARAMETERS);
  }

  /**
   * Retrieves an SSLContext by loading a file from HashiCorp Vault Dedicated and
   * configuring it for secure TLS communication with Autonomous Database.
   * <p>
   * The file is stored in HashiCorp Vault Dedicated as a base64-encoded string.
