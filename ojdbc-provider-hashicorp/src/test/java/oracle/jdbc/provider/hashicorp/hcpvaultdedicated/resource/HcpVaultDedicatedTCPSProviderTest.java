...
public class HcpVaultDedicatedTCPSProviderTest {

  private static final TlsConfigurationProvider PROVIDER = findProvider(
    TlsConfigurationProvider.class, "ojdbc-provider-hcpvault-dedicated-tls");
  ...
  /**
   * Test retrieving an SSLContext from a PKCS12 TCPS wallet.
   */
  @Test
  public void testRetrieveSSLContextFromPKCS12() {
    ...
    testParameters.put("fieldName", "base64-wallet-p12");
  ...
  /**
   * Test retrieving an SSLContext from an SSO TCPS wallet.
   */
  @Test
  public void testRetrieveSSLContextFromSSO() {
    ...
    testParameters.put("fieldName", "base64-wallet-sso");
  ...
  /**
   * Test retrieving an SSLContext from a PEM TCPS wallet.
   */
  @Test
  public void testRetrieveSSLContextFromPEM() {
    ...
    testParameters.put("fieldName", "base64-wallet-pem");
    testParameters.put("walletPassword", TestProperties.getOrAbort(DedicatedVaultTestProperty.WALLET_PASSWORD));
  ...
  /**
   * Test missing password for a PKCS12 TCPS wallet.
   */
  @Test
  ...
  /**
   * Test missing password for a PEM TCPS wallet.
   */
  @Test
