...
public class HcpVaultDedicatedUsernameProviderTest {

  private static final UsernameProvider PROVIDER =
          findProvider(UsernameProvider.class, "ojdbc-provider-hcpvault-dedicated-username");
  ...
  public void testRetrieveUsername() {
    ...
    testParameters.put("secretPath",
            TestProperties.getOrAbort(DedicatedVaultTestProperty.PASSWORD_SECRET_PATH));
