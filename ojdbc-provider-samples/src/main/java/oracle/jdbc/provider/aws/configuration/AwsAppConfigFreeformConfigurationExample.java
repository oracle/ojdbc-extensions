 ...
 * connection properties retrieved from AWS AppConfig Freeform Configuration.
 */
public class AwsAppConfigFreeformConfigurationExample {
  ...
  public static void main(String[] args) throws SQLException {
    ...
    if (args.length == 0) {
      ...
      // The {application-identifier} can be the application ID or name, and
      url = "jdbc:oracle:thin:@config-awsappconfig://app-name" +
              "?appconfig_environment=your-environment&appconfig_profile=your-profile";
    } else {
      url = args[0];
    }
