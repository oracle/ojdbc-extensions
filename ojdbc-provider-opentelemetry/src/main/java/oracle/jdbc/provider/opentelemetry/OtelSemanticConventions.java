 ...
 * <p>
 * This class contains attribute names used by {@link OpenTelemetryTraceEventListener}
 * for instrumenting Oracle JDBC operations according to the OpenTelemetry Database
 * Semantic Conventions for Oracle Database.
 * </p>
 * <p>
 * Attributes are organized into three categories:
 * <ul>
 *   <li><b>Stable Semantic Conventions</b> - Standard OpenTelemetry attributes</li>
 *   <li><b>Oracle-Specific Custom Attributes</b> - Oracle Database vendor-specific attributes</li>
 *   <li><b>Legacy Attributes</b> - Backward compatibility with experimental conventions</li>
 * </ul>
 * </p>
 *
 */
