...
import oracle.jdbc.provider.configuration.secretMapUtil;
 ...
 */
public final class AzureVaultJsonSecretProvider
  ...
  public char[] getSecret(Map<String, String> secretMap) {
    // TO-DO: modify JsonSecretUtil.toNamedValues()
    OracleJsonObject secretJsonObject = null;
//    ParameterSet parameterSet =
//      PARAMETER_SET_PARSER.parseNamedValues(
//        secretMapUtil.extractRequiredNamedValues(secretJsonObject));
    ParameterSet parameterSet =
      PARAMETER_SET_PARSER.parseNamedValues(secretMap
      );
