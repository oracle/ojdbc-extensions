...
public class AccessTokenFactoryTest {
    ...
    public void testCreateAccessToken() throws InterruptedException {
        ...
        accessTokenFactorySpy.request( tokenCredential,parameterSetMock);
        long duration1 = (System.currentTimeMillis()-start);
        System.out.println("first request took like "+duration1);
        // verify the token is requested from azure the first time
        verify(accessTokenFactorySpy,times(1)).requestAzureAccessToken(any(),anyString());
        ...
        //verify
        verify(accessTokenFactorySpy,never()).requestAzureAccessToken(any(),anyString());
