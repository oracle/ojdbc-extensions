...
public enum AzureTestProperty {
  ...
  AZURE_APP_CONFIG_KEY_INVALID_PROPERTIES,

  AZURE_APP_CONFIG_KEY_NON_WHITELISTED_PROPERTIES,
  ...
  AZURE_PKCS12_TLS_WALLET_SECRET_NAME,

  AZURE_PKCS12_TLS_WALLET_PASSWORD,

  AZURE_SSO_TLS_WALLET_SECRET_NAME,

  AZURE_PEM_TLS_WALLET_SECRET_NAME,

  AZURE_PEM_TLS_WALLET_PASSWORD,

  AZURE_CORRUPTED_TLS_WALLET_SECRET_NAME,

  AZURE_PKCS12_SEPS_WALLET_PASSWORD,

  AZURE_PKCS12_SEPS_WALLET_SECRET_NAME,

  AZURE_SSO_SEPS_WALLET_SECRET_NAME,
  ...
  AZURE_TNS_ALIAS_SECRET_NAME,

  AZURE_NON_BASE64_TNS_NAMES_SECRET_NAME;
