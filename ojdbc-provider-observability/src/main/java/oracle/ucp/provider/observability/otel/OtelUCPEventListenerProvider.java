 ...
 * following database client semantic conventions. Users must configure
 * the OpenTelemetry SDK separately - this provider only generates
 * metrics.
 * </p>
 *
 * <h2>Configuration</h2>
 ...
 * <h3>Gauges (7)</h3>
 * <ul>
 *   <li>{@code db.client.connections.used} - Currently in-use
 *   connections (state=used)</li>
 *   <li>{@code db.client.connections.idle} - Currently idle connections
 *   (state=idle)</li>
 *   <li>{@code db.client.connections.count} - Total connections
 *   (borrowed + idle)</li>
 *   <li>{@code db.client.connections.max} - Maximum pool size</li>
 *   <li>{@code db.client.connections.min} - Minimum pool size</li>
 *   <li>{@code db.client.connections.created} - Total connections
 *   created since pool inception</li>
 *   <li>{@code db.client.connections.closed} - Total connections closed
 *   since pool inception</li>
 * </ul>
 *
 * <h3>Counters (14)</h3>
 * <ul>
 *   <li>{@code db.client.connection.pool.created} - Pool creation
 *   events</li>
 *   <li>{@code db.client.connection.pool.starting} - Pool starting
 *   events</li>
 *   <li>{@code db.client.connection.pool.started} - Pool started
 *   events</li>
 *   <li>{@code db.client.connection.pool.stopped} - Pool stopped
 *   events</li>
 *   <li>{@code db.client.connection.pool.restarting} - Pool restarting
 *   events</li>
 *   <li>{@code db.client.connection.pool.restarted} - Pool restarted
 *   events</li>
 *   <li>{@code db.client.connection.pool.destroyed} - Pool destruction
 *   events</li>
 *   <li>{@code db.client.connection.created} - Connection creation
 *   events</li>
 *   <li>{@code db.client.connection.borrowed} - Connection borrow
 *   events</li>
 *   <li>{@code db.client.connection.returned} - Connection return
 *   events</li>
 *   <li>{@code db.client.connection.closed} - Connection close
 *   events</li>
 *   <li>{@code db.client.connection.pool.refreshed} - Pool refresh
 *   operations</li>
 *   <li>{@code db.client.connection.pool.recycled} - Pool recycle
 *   operations</li>
 *   <li>{@code db.client.connection.pool.purged} - Pool purge
 *   operations</li>
 * </ul>
 *
 * <h3>Histograms (1)</h3>
 * <ul>
 *   <li>{@code db.client.connections.wait_time} - Connection
 *   acquisition wait time (milliseconds)</li>
 * </ul>
 *
 * <h2>Attributes</h2>
 * <ul>
 *   <li>{@code pool.name} - Name of the connection pool</li>
 *   <li>{@code state} - Connection state (used/idle) for connection
 *   state gauges</li>
 * </ul>
 *
 * <h2>Requirements</h2>
 ...
 *   <li>OpenTelemetry API 1.0+</li>
 *   <li>OpenTelemetry SDK must be configured separately by the
 *   user</li>
 * </ul>
 *
 * @since 1.0
