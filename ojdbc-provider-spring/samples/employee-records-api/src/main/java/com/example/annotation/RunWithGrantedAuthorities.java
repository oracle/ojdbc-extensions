 ...
 *  - one authority carrying the attributes JSON as "ORACLE_CONTEXT_ATTRIBUTE_<json>"
 *
 * Mirrors SessionContextUtil.runWithGrantedAuthorities behavior for tests.
 *
 ...
 *    - Provide literal values for dataRoles and contextAttributes (e.g., string/array literals).
 ...
 *    </pre> {@code
 *    @RunWithGrantedAuthorities(
 *      dataRoles = {"HR_DYNAMIC_ROLE","HCM_APP_DATA_ROLE","HCM_APP_DATA_PERMISSION"},
 *      contextAttributes = "{\"HR_APP_NAMESPACE\":{\"DEPT\":\"90\",\"TITLE\":\"Developer\"}}"
 *    )
...
@Documented
public @interface RunWithGrantedAuthorities {
  ...
  /**
   * JSON string of namespace attributes, added as a single GrantedAuthority value:
   * "ORACLE_CONTEXT_ATTRIBUTE_<json>".
   * Example: {"HR_APP_NAMESPACE":{"DEPT":"90","TITLE":"Developer"}}
   */
  String contextAttributes() default "";
}
